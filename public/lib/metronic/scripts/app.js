...
var App = function() {
    ...
    return {
        ...
        getCurrentStyle: function(color) {
            ...
            if (_clrs[color]) {
                return '<style type="text/css" id="curr">.curr_bg{background: ' 
                + _bgs[color] + ';border: 1px solid ' + _bgs[color] 
                + ';border-top: 0;} .curr_btn{color: ' + _clrs[color] 
                + ';background: ' + _bgs[color] + ';} .curr_btn:hover{color: ' + _clrs[color] 
                + ';background: ' + _overs[color] + ';text-decoration: none !important;}</style>';
            } else {
                return '<style type="text/css" id="curr">.curr_bg{background: ' 
                + _bgs.default + ';border: 1px solid ' + _bgs.default 
                + ';border-top: 0;} .curr_btn{color: ' + _clrs.default 
                + ';background: ' + _bgs.default + ';} .curr_btn:hover{color: ' + _clrs.default 
                + ';background: ' + _overs.default + ';text-decoration: none !important;}</style>';
            }
        }
